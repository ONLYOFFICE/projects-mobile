...
class PlatformIcons {
  ...
  IconData get accountCircle =>
      isMaterial(context) ? Icons.account_circle_outlined : CupertinoIcons.person_crop_circle;

  /// Icons: Icons.account_circle : CupertinoIcons.person_crop_circle_fill
  IconData get accountCircleSolid =>
      isMaterial(context) ? Icons.account_circle : CupertinoIcons.person_crop_circle_fill;
  ...
  IconData get addCircled => isMaterial(context) ? Icons.add_circle : CupertinoIcons.add_circled;

  /// Icons: Icons.add_circle_outline : CupertinoIcons.add_circled
  IconData get addCircledOutline =>
      isMaterial(context) ? Icons.add_circle_outline : CupertinoIcons.add_circled;
  ...
  IconData get back => isMaterial(context) ? Icons.arrow_back_rounded : CupertinoIcons.back;
  ...
  IconData get batteryCharging =>
      isMaterial(context) ? Icons.battery_charging_full : CupertinoIcons.battery_charging;
  ...
  IconData get bluetooth => isMaterial(context) ? Icons.bluetooth : CupertinoIcons.bluetooth;
  ...
  IconData get bookmark => isMaterial(context) ? Icons.bookmark : CupertinoIcons.bookmark;
  ...
  IconData get brightness => isMaterial(context) ? Icons.brightness_low : CupertinoIcons.brightness;

  /// Icons: Icons.brightness_high : CupertinoIcons.brightness_solid
  IconData get brightnessSolid =>
      isMaterial(context) ? Icons.brightness_high : CupertinoIcons.brightness_solid;
  ...
  IconData get clearThick => isMaterial(context) ? Icons.clear : CupertinoIcons.clear_thick;
  ...
  IconData get clockSolid => isMaterial(context) ? Icons.watch_later : CupertinoIcons.clock_solid;

  /// Icons: Icons.cloud_outlined : CupertinoIcons.cloud
  IconData get cloud => isMaterial(context) ? Icons.cloud_outlined : CupertinoIcons.cloud;

  /// Icons: Icons.cloud : CupertinoIcons.cloud_fill
  IconData get cloudSolid => isMaterial(context) ? Icons.cloud : CupertinoIcons.cloud_fill;

  /// Icons: Icons.collections : CupertinoIcons.collections
  IconData get collections => isMaterial(context) ? Icons.collections : CupertinoIcons.collections;

  /// Icons: Icons.collections : CupertinoIcons.collections_solid
  IconData get collectionsSolid =>
      isMaterial(context) ? Icons.collections : CupertinoIcons.collections_solid;

  /// Icons: Icons.chat_bubble : CupertinoIcons.conversation_bubble
  IconData get conversationBubble =>
      isMaterial(context) ? Icons.chat_bubble : CupertinoIcons.conversation_bubble;

  /// Icons: Icons.chat_bubble_outline : CupertinoIcons.conversation_bubble
  IconData get conversationBubbleOutline =>
      isMaterial(context) ? Icons.chat_bubble_outline : CupertinoIcons.conversation_bubble;
  ...
  IconData get create => isMaterial(context) ? Icons.create : CupertinoIcons.create;

  // IconData get createSolid =>
  //     isMaterial(context) ? Icons. : CupertinoIcons.create_solid;

  /// Icons: Icons.dehaze : CupertinoIcons.bars
  IconData get dehaze => isMaterial(context) ? Icons.dehaze : CupertinoIcons.bars;

  /// Icons: Icons.delete : CupertinoIcons.delete
  IconData get delete => isMaterial(context) ? Icons.delete : CupertinoIcons.delete;
  ...
  IconData get deleteSolid => isMaterial(context) ? Icons.delete : CupertinoIcons.delete_solid;

  /// Icons: Icons.delete_outline : CupertinoIcons.delete
  IconData get deleteOutline => isMaterial(context) ? Icons.delete_outline : CupertinoIcons.delete;
  ...
  IconData get eyeSlash =>
      isMaterial(context) ? Icons.visibility_off_outlined : CupertinoIcons.eye_slash;
  ...
  IconData get eyeSolid => isMaterial(context) ? Icons.visibility : CupertinoIcons.eye_solid;

  /// Icons: Icons.favorite : CupertinoIcons.heart_solid
  IconData get favoriteSolid => isMaterial(context) ? Icons.favorite : CupertinoIcons.heart_solid;
  ...
  IconData get folder => isMaterial(context) ? Icons.folder : CupertinoIcons.folder;

  /// Icons: Icons.folder_open : CupertinoIcons.folder_open
  IconData get folderOpen => isMaterial(context) ? Icons.folder_open : CupertinoIcons.folder_open;

  /// Icons: Icons.folder : CupertinoIcons.folder_solid
  IconData get folderSolid => isMaterial(context) ? Icons.folder : CupertinoIcons.folder_solid;

  /// Icons: Icons.arrow_forward : CupertinoIcons.forward
  IconData get forward => isMaterial(context) ? Icons.arrow_forward : CupertinoIcons.forward;

  /// Icons: Icons.fullscreen : CupertinoIcons.fullscreen
  IconData get fullscreen => isMaterial(context) ? Icons.fullscreen : CupertinoIcons.fullscreen;

  /// Icons:
  IconData get fullscreenExit =>
      isMaterial(context) ? Icons.fullscreen_exit : CupertinoIcons.fullscreen_exit;
  ...
  IconData get gearSolid => isMaterial(context) ? Icons.settings : CupertinoIcons.gear_solid;

  /// Icons: Icons.group : CupertinoIcons.group
  IconData get group => isMaterial(context) ? Icons.group : CupertinoIcons.group;

  /// Icons: Icons.group : CupertinoIcons.group_solid
  IconData get groupSolid => isMaterial(context) ? Icons.group : CupertinoIcons.group_solid;

  // IconData get heart => isMaterial(context) ? Icons. : CupertinoIcons.heart;

  /// Icons: Icons.favorite : CupertinoIcons.heart_solid
  IconData get heartSolid => isMaterial(context) ? Icons.favorite : CupertinoIcons.heart_solid;

  /// Icons: Icons.help : CupertinoIcons.question_circle_fill
  IconData get help => isMaterial(context) ? Icons.help : CupertinoIcons.question_circle_fill;
  ...
  IconData get mailSolid => isMaterial(context) ? Icons.mail : CupertinoIcons.mail_solid;

  /// Icons: Icons.mail_outline : CupertinoIcons.mail
  IconData get mailOutline => isMaterial(context) ? Icons.mail_outline : CupertinoIcons.mail;
  ...
  IconData get micOff => isMaterial(context) ? Icons.mic_off : CupertinoIcons.mic_off;

  /// Icons: Icons.mic_none : CupertinoIcons.mic
  IconData get micOutline => isMaterial(context) ? Icons.mic_none : CupertinoIcons.mic;

  /// Icons: Icons.mic : CupertinoIcons.mic_solid
  IconData get micSolid => isMaterial(context) ? Icons.mic : CupertinoIcons.mic_solid;
  ...
  IconData get musicNote => isMaterial(context) ? Icons.music_note : CupertinoIcons.music_note;
  ...
  IconData get padLock => isMaterial(context) ? Icons.lock : CupertinoIcons.padlock;

  /// Icons: Icons.lock_outline : CupertinoIcons.padlock
  IconData get padlockOutline => isMaterial(context) ? Icons.lock_outline : CupertinoIcons.padlock;

  /// Icons: Icons.lock : CupertinoIcons.padlock_solid
  IconData get padlockSolid => isMaterial(context) ? Icons.lock : CupertinoIcons.padlock_solid;

  /// Icons: Icons.pause : CupertinoIcons.pause
  IconData get pause => isMaterial(context) ? Icons.pause : CupertinoIcons.pause;
  ...
  IconData get pawSolid => isMaterial(context) ? Icons.pets : CupertinoIcons.paw_solid;
  ...
  IconData get person => isMaterial(context) ? Icons.person : CupertinoIcons.person;

  /// Icons: Icons.person_add : CupertinoIcons.person_add
  IconData get personAdd => isMaterial(context) ? Icons.person_add : CupertinoIcons.person_add;
  ...
  IconData get personOutline => isMaterial(context) ? Icons.person_outline : CupertinoIcons.person;

  /// Icons: Icons.person : CupertinoIcons.person_solid
  IconData get personSolid => isMaterial(context) ? Icons.person : CupertinoIcons.person_solid;

  /// Icons: Icons.phone : CupertinoIcons.phone
  IconData get phone => isMaterial(context) ? Icons.phone : CupertinoIcons.phone;

  /// Icons: Icons.phone : CupertinoIcons.phone_solid
  IconData get phoneSolid => isMaterial(context) ? Icons.phone : CupertinoIcons.phone_solid;
  ...
  IconData get photoCameraSolid =>
      isMaterial(context) ? Icons.photo_camera : CupertinoIcons.photo_camera_solid;

  /// Icons: Icons.photo_library_outlined : CupertinoIcons.photo_on_rectangle
  IconData get photoLibrary =>
      isMaterial(context) ? Icons.photo_library_outlined : CupertinoIcons.photo_on_rectangle;

  /// Icons: Icons.photo_library : CupertinoIcons.photo_fill_on_rectangle_fill
  IconData get photoLibrarySolid =>
      isMaterial(context) ? Icons.photo_library : CupertinoIcons.photo_fill_on_rectangle_fill;

  /// Icons: Icons.play_arrow : CupertinoIcons.play_arrow
  IconData get playArrow => isMaterial(context) ? Icons.play_arrow : CupertinoIcons.play_arrow;
  ...
  IconData get playCircle =>
      isMaterial(context) ? Icons.play_circle_outline : CupertinoIcons.play_circle;
  ...
  IconData get refresh => isMaterial(context) ? Icons.refresh : CupertinoIcons.refresh;

  /// Icons: Icons.refresh : CupertinoIcons.refresh_bold
  IconData get refreshBold => isMaterial(context) ? Icons.refresh : CupertinoIcons.refresh_bold;
  ...
  IconData get remove => isMaterial(context) ? Icons.remove : CupertinoIcons.minus;
  ...
  IconData get removeCircledOutline =>
      isMaterial(context) ? Icons.remove_circle_outline : CupertinoIcons.minus_circle;

  /// Icons: Icons.remove_circle : CupertinoIcons.minus_circle_fill
  IconData get removeCircledSolid =>
      isMaterial(context) ? Icons.remove_circle : CupertinoIcons.minus_circle_fill;

  /// Icons: Icons.reply : CupertinoIcons.reply
  IconData get reply => isMaterial(context) ? Icons.reply : CupertinoIcons.reply;

  /// Icons: Icons.reply_all : CupertinoIcons.reply_all
  IconData get replyAll => isMaterial(context) ? Icons.reply_all : CupertinoIcons.reply_all;
  ...
  IconData get search => isMaterial(context) ? Icons.search : CupertinoIcons.search;

  /// Icons: Icons.settings : CupertinoIcons.settings
  IconData get settings => isMaterial(context) ? Icons.settings : CupertinoIcons.settings;
  ...
  IconData get share => isMaterial(context) ? Icons.share : CupertinoIcons.share;

  /// Icons: Icons.share : CupertinoIcons.share_solid
  IconData get shareSolid => isMaterial(context) ? Icons.share : CupertinoIcons.share_solid;
  ...
  IconData get shuffle => isMaterial(context) ? Icons.shuffle : CupertinoIcons.shuffle;
  ...
  IconData get switchCameraSolid =>
      isMaterial(context) ? Icons.switch_camera : CupertinoIcons.switch_camera_solid;
  ...
  IconData get tagOutline => isMaterial(context) ? Icons.label_outline : CupertinoIcons.tag;

  /// Icons: Icons.label : CupertinoIcons.tag_solid
  IconData get tagSolid => isMaterial(context) ? Icons.label : CupertinoIcons.tag_solid;
  ...
  IconData get thumbDown =>
      isMaterial(context) ? Icons.thumb_down : CupertinoIcons.hand_thumbsdown_fill;

  /// Icons: Icons.thumb_down_outlined : CupertinoIcons.hand_thumbsdown
  IconData get thumbDownOutlined =>
      isMaterial(context) ? Icons.thumb_down_outlined : CupertinoIcons.hand_thumbsdown;

  /// Icons: Icons.thumb_up : CupertinoIcons.hand_thumbsup_fill
  IconData get thumbUp => isMaterial(context) ? Icons.thumb_up : CupertinoIcons.hand_thumbsup_fill;

  /// Icons: Icons.thumb_up_outlined : CupertinoIcons.hand_thumbsup
  IconData get thumbUpOutlined =>
      isMaterial(context) ? Icons.thumb_up_outlined : CupertinoIcons.hand_thumbsup;
  ...
  IconData get timeSolid => isMaterial(context) ? Icons.watch_later : CupertinoIcons.time_solid;

  /// Icons: Icons.tram : CupertinoIcons.train_style_one
  IconData get train => isMaterial(context) ? Icons.tram : CupertinoIcons.train_style_one;
  ...
  IconData get upArrow => isMaterial(context) ? Icons.arrow_upward : CupertinoIcons.up_arrow;

  /// Icons: Icons.videocam : CupertinoIcons.video_camer
  IconData get videoCamera => isMaterial(context) ? Icons.videocam : CupertinoIcons.video_camera;
  ...
  IconData get volumeDown => isMaterial(context) ? Icons.volume_down : CupertinoIcons.volume_down;

  /// Icons: Icons.volume_mute : CupertinoIcons.volume_mute
  IconData get volumeMute => isMaterial(context) ? Icons.volume_mute : CupertinoIcons.volume_mute;

  /// Icons: Icons.volume_off : CupertinoIcons.volume_off
  IconData get volumeOff => isMaterial(context) ? Icons.volume_off : CupertinoIcons.volume_off;

  /// Icons: Icons.volume_up : CupertinoIcons.volume_up
  IconData get volumeUp => isMaterial(context) ? Icons.volume_up : CupertinoIcons.volume_up;
  ...
  IconData get wifiOff => isMaterial(context) ? Icons.wifi_off : CupertinoIcons.wifi_slash;
}
