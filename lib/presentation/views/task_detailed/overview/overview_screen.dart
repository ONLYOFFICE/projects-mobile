          ...
          return SmartRefresher(
            ...
            child: ListView(
              children: [
                ...
                InfoTile(
                  icon: AppIcon(
                      icon: SvgIcons.milestone, color: const Color(0xff707070)),
                  caption: 'Milestone:',
                ...
                InfoTile(
                    icon: AppIcon(
                        icon: SvgIcons.person, color: const Color(0xff707070)),
                    caption: 'Assigned to:',
                    subtitle: '2 responsibles'),
                const SizedBox(height: 20),
                const InfoTile(caption: 'Created by:', subtitle: 'S. Leushkin'),
                const SizedBox(height: 20),
                const InfoTile(
                    caption: 'Creation date:', subtitle: '21 Mar 2021'),
...
String _text =
    'Aliqua id fugiat nostrud irure ex duis ea quis id quis ad et. Sunt qui esse pariatur duis deserunt mollit dolore cillum m... Show more';
